...
public class CollisionChecker {
    ...
    public int checkObject(entity entity, boolean player)
    {
        ...
        {
                if (gp.obj[TileManager.getMapID()][i] != null) {
                    ...
                    gp.obj[TileManager.getMapID()][i].solidArea.x = gp.obj[TileManager.getMapID()][i].worldX + gp.obj[TileManager.getMapID()][i].solidArea.x;
                    gp.obj[TileManager.getMapID()][i].solidArea.y = gp.obj[TileManager.getMapID()][i].worldY + gp.obj[TileManager.getMapID()][i].solidArea.y;

                    switch (entity.direction) {
                        case "up":
                            entity.solid.y -= entity.speed;
                            //this if function checks when the two rectangles intersect
                            if (entity.solid.intersects(gp.obj[TileManager.getMapID()][i].solidArea)) {
                                //if the object has collision then this sets it to true
                                if (gp.obj[TileManager.getMapID()][i].collision == true) {
                                    entity.collisionOn = true;
                                }
                    ...
                    gp.obj[TileManager.getMapID()][i].solidArea.x = gp.obj[TileManager.getMapID()][i].solidAreaDefaultX;
                    gp.obj[TileManager.getMapID()][i].solidArea.y = gp.obj[TileManager.getMapID()][i].solidAreaDefaultY;
                }
        }
        return index;
    }
